...
import { runFeatureMatrixJob, getFeatureMatrixDownloadUrl, FEATURE_MATRIX_CSV_FILENAME } from '../services/featureMatrixJobs'
import type {
  CsvDataMode,
...
export function FeatureMatrixPage() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      unsubscribeRef.current = runFeatureMatrixJob(
        accountId,
        dataMode,
        context || undefined,
