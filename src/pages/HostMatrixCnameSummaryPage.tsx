...
import {
  runHostnameCnameMatrixSummaryJob,
  getHostnameCnameMatrixDownloadUrl,
  HOST_MATRIX_CNAME_CSV_FILENAME,
...
export function HostMatrixCnameSummaryPage() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      unsubscribeRef.current = runHostnameCnameMatrixSummaryJob(
        accountId,
        dataMode,
        context || undefined,
        ...
        {result ? (
          <p className="text-xs font-semibold text-slate-600">
            ...
            <a
              ...
              href={getHostnameCnameMatrixDownloadUrl(accountId, context || undefined)}
              target="_blank"
              rel="noreferrer"
            >
              {HOST_MATRIX_CNAME_CSV_FILENAME}
