...
export function PerfMatrixPage() {
  ...
  const [result, setResult] = useState<PerfMatrixResult | null>(null)
  ...
  // Deep-link support: /perfMatrix/:hostname pre-selects a hostname for filtering and the trend chart.
  useEffect(() => {
  ...
  return (
    <DashboardLayout title="Performance Matrix (Core Web Vitals)">
          ...
          <>
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-card">
              <div className="mb-4 flex flex-wrap items-center gap-3">
                <h2 className="text-lg font-bold text-slate-800">Property / Performance Matrix</h2>
